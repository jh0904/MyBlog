    ...
    function putInArticle(data) {
        ...
        $('.other').append($('<div class="social-share" data-initialized="true" data-url="http://www.itclub.fun/findArticle?articleId=' + data.articleId + '"  data-title="' + data.articleTitle + '">' +
