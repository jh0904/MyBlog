    ...
    function putIn() {
        ...
        var register_success_img = $('<div class="register_success_img">\n' +
            '            <img src="https://blog-myblog.oss-cn-shenzhen.aliyuncs.com/static/img/register_success.gif" class="am-img-thumbnail">\n' +
            '        </div>');
        sec.append(register_success_img);

        var register_success_words = $('<div class="register_success_words">\n' +
            '            <img src="https://blog-myblog.oss-cn-shenzhen.aliyuncs.com/static/img/register_icon.png">\n' +
            '            <p>恭喜注册成功，快去登录吧</p>\n' +
            '        </div>');
